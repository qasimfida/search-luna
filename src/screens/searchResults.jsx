...
export const SearchResults = ({
  ...
  return (
    <div className="cc-p-4 xl:cc-p-10 xl:cc-flex xl:cc-flex-col xl:cc-w-100">
      ...
      <div className="cc-grid cc-gap-6 cc-grid-cols-1 sm:cc-grid-cols-2 md:cc-grid-cols-3 md:cc-overflow-x-scroll 2xl:cc-grid-cols-3 lg:cc-overflow-hidden cc-p-4 ">
