        ...
        <div>
          <div className="cc-flex cc-items-end cc-justify-center">
            {cans.map((bucket, index) => (
              <div key={`bucket-${index}`} className="cc-flex cc-flex-col cc-items-center">
                ...
                <div className="flex">
                <p className="cc-text-black cc-py-2 cc-text-sm cc-text-center">{`$${(getPrice(bucket.name, recipeData.suffix))}`}</p>
                <Button variant="outline" className="cc-h-8 cc-px-10" onClick={(e) => handleCheckout(e, bucket)}>Buy</Button>
              </div>
              </div>
            ))}
      ...
      >
        <div>
          ...
          <div className="cc-px-8 xl:cc-flex cc-justify-center ">
              <div>
                <h4 className="cc-text-lg cc-text-black cc-font-medium cc-mb-2 cc-text-center">Undercoat you need</h4>
                <NewCard
