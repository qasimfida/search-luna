...
* <pre>
* var LunaPaintApi = require('index'); // See note below*.
* var xxxSvc = new LunaPaintApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new LunaPaintApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new LunaPaintApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new LunaPaintApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
