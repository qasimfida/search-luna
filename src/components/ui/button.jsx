  ...
  "cc-inline-flex cc-items-center cc-h-12 cc-justify-center cc-whitespace-nowrap cc-rounded-md cc-text-sm cc-font-medium cc-ring-offset-white cc-transition-colors focus-visible:cc-outline-none focus-visible:cc-ring-2 focus-visible:cc-ring-slate-950 focus-visible:cc-ring-offset-2 disabled:cc-pointer-events-none disabled:cc-opacity-50 dark:cc-ring-offset-slate-950 dark:focus-visible:cc-ring-slate-300 ",
  {
    variants: {
      variant: {
        ...
        outline:
          "cc-border-2 cc-border-black cc-text-black cc-h-10 cc-bg-white hover:cc-bg-slate-100 hover:cc-text-slate-900 dark:cc-border-slate-800 dark:cc-bg-slate-950 dark:hover:cc-bg-slate-800 dark:hover:cc-text-slate-50",
        secondary:
