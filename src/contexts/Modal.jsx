...
export function Modal({ children, ...props }) {
    ...
    return createPortal(
        <motion.div
            ...
            className={`cc-fixed cc-z-[999] cc-w-full cc-h-full  cc-top-0 cc-left-0 cc-overflow-y-hidden cc-overflow-x-hidden cc-bg-black/50`}
            {...propsRest}
        >
            <CustomModal isOpen={isOpen} onClose={closeModal}>
                ...
                <div className="cc-relative cc-w-full cc-bg-white cc-overflow-hidden cc-rounded-[48px] lg:cc-min-h-[calc(100dvh-2*1.75rem)]">
